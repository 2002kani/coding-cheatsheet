...
const cheatsheet = [
  ...
  { title: "indexOf()", description: "Returns the first index at which a given element can be found in the array, or -1 if it is not present.", 
      code1: "const list = [1, 2, 3, 4, 5];", 
  ...
  { title: "shift()", description: "emoves the first element from an array and returns that element.", 
      code1: "const list = [1, 2, 3, 4, 5];", 
  ...
  { title: "splice()", description: "Changes the contents of an array by removing or replacing existing elements and/or adding new elements in place.", 
      code1: "const list = [1, 2, 3, 4, 5];", 
  ...
  { title: "sort()", description: "Sorts the elements of an array in place and returns the array. The default sort order is according to string Unicode code points.", 
      code1: "const array = [4, 1, 3, 2, 10];", 
      code2: "array.sort();", code2Lösung: "// [1, 10, 2, 3, 4]", 
      code3: "array.sort((a, b) => a - b);", code3Lösung: "// [1, 2, 3, 4, 10]" },
  { title: "some()", description: "Returns true if at least one element in the array passes the test implemented by the provided function.", 
      code1: "const list = [1, 2, 3, 4, 5];", 
